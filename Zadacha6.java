...
public class Zadacha6 {
    public static void main(String[] args) {
        ...
        if (n == 1) {
            String[] units = {"Килограммы:","Стоны:", "Унции:", "Фунты:"};

            //Массив coefs содержит коэффициенты конвертации i-ой единицы в j-ую
            double[][] coefs = {{1, 0.15747, 35.274, 2.20462}, {6.35029, 1, 224, 14},
            ...
            double[][] coefs = {{1, 0.00062, 1.09361, 3.28084}, {1609.34, 1, 1760, 5280},
